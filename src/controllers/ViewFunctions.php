...
function Blue_Triangle_Automated_CSP_Free_General_Page(){
    ...
    require_once(  ABSPATH . 'wp-content/plugins/btt-auto-csp-free/src/views/general-view.php' );
}
...
function Blue_Triangle_Automated_CSP_Free_Violations(){
    ...
    require_once(  ABSPATH . 'wp-content/plugins/btt-auto-csp-free/src/views/violations-view.php' );
}
...
function Blue_Triangle_Automated_CSP_Free_Directives_Page(){
    ...
    require_once(  ABSPATH . 'wp-content/plugins/btt-auto-csp-free/src/views/directives-view.php' );
}
...
function Blue_Triangle_Automated_CSP_Free_Help_Center(){
    ...
    require_once(  ABSPATH . 'wp-content/plugins/btt-auto-csp-free/src/views/help-view.php' );
}